    ...
    <div data-test="newMountModalComponent">
      ...
      <Modal isOpen={modal} toggle={toggle} className={className}>
        <ModalHeader toggle={toggle}>
          {intl.formatMessage({
            id: "MountDashboard.NewMountModal.NewMount",
            defaultMessage: "New Mount",
          })}
        </ModalHeader>
        <ModalBody>
          <FormGroup row>
            <Label for={"mountFs"} sm={5}>
              {intl.formatMessage({
                id: "MountDashboard.NewMountModal.Fs",
                defaultMessage: "Fs",
              })}
            </Label>
            <Col sm={7}>
          ...
          {mountFs && (
            <FormGroup row>
              <Label for={"mountPoint"} sm={5}>
                {intl.formatMessage({
                  id: "MountDashboard.NewMountModal.MountPoint",
          ...
          <Row>
            <Col lg={6}>
              <p>
                {intl.formatMessage({
                  id: "MountDashboard.NewMountModal.MountOptions",
                  defaultMessage: "Mount Options",
                })}
              </p>
              <MountOptions
                isValidMap={isValid}
            ...
            <Col lg={6}>
              <p>
                {intl.formatMessage({
                  id: "MountDashboard.NewMountModal.VFSOptions",
                  defaultMessage: "VFS Options",
                })}
              </p>
              <MountOptions
                isValidMap={isValid}
        ...
        <ModalFooter>
          <Button
            ...
            {intl.formatMessage({
              id: "MountDashboard.NewMountModal.Create",
              defaultMessage: "Create",
            })}
          </Button>{" "}
          <Button data-test="cancel-button" color="secondary" onClick={toggle}>
            {intl.formatMessage({
              id: "MountDashboard.NewMountModal.Cancel",
